        ...
        <div class="cutie-card p-10 md:p-16 relative overflow-hidden">
            ...
            <div class="relative z-10">
                <div class="text-center mb-12">
                    ...
                    <h2 class="text-4xl font-black text-zinc-800 tracking-tight">Edit <span class="text-pink-500 italic">Destinasi</span></h2>
                    <p class="text-zinc-400 font-bold mt-2">Perbarui data dengan penuh semangat! ✨</p>
                </div>

                <form action="{{ route('wisata.update', $wisata->id) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="pt-10 flex justify-center">
                        <button type="submit" class="bg-[#fb7185] border-bottom-4 border-[#e11d48] rounded-[2rem] text-white font-black px-16 py-6 text-xl shadow-xl shadow-pink-100 hover:scale-105 active:scale-95 transition-all flex items-center gap-4">
                            <span>🚀</span> UPDATE DATA AJAIB <span>🚀</span>
                        </button>
                    </div>
                </form>
            </div>
